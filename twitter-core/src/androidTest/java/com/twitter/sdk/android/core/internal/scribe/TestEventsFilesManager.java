...
public class TestEventsFilesManager extends EventsFilesManager<TestEvent> {

    private final String rollOverFileName;

    public TestEventsFilesManager(Context context, EventTransform<TestEvent> transform,
